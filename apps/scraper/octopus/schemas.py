...
class BrowserAction(BaseModel):
    ...
    timeout_ms: int = 5000
    path: Optional[str] = None  # For screenshot action
...
class OctopusRequest(BaseModel):
    ...
    proxy_url: Optional[str] = None  # "http://user:pass@host:port" — never logged
...
class OctopusResult(BaseModel):
    ...
    document_tables: Optional[List[Any]] = None
