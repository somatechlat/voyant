...
class SeleniumClient:
    ...
    def fetch_page(self, url: str, wait_for: Optional[str] = None, timeout: int = 30) -> str:
        """
    ...
    def perform_actions(
        self, url: str, actions: List[Dict[str, Any]], wait_for: Optional[str] = None, timeout: int = 30
    ) -> str:
        """
