    ...
    def handle(self, *args, **options):
        ...
        planes_data = [
            ...
            (
                ...
                19.13,
                True,
                "Plan avanzado con 45% descuento, incluye Disney+ y Paramount+",
            ),
            (
                "Elite Plus 800M",
                "fibra",
                ...
                25.50,
                True,
                "Plan elite con 35% descuento, incluye streaming",
            ),
            (
                "Elite Paramount 800M",
                "fibra",
                "800 Mbps",
                22.10,
                True,
                "Plan elite con Paramount+ incluido",
            ),
            (
                "Elite Pro 800M",
                "fibra",
            ...
            (
                ...
                34.00,
                True,
                "Plan supreme con 38% descuento, Disney+, Paramount+, HBO",
            ),
            (
                "Supreme Pro 1000M",
                "fibra",
                ...
                60.00,
                True,
                "Plan supreme pro con todos los streaming",
            ),
            (
                "Prime 1000M",
                "fibra",
                ...
                70.00,
                True,
                "Plan premium con todos los streaming:"
                " Disney+, Paramount+, HBO, Zapping Pro,"
                " Liga Ecuabet",
            ),
        ]
        planes = {}
        for nombre, tipo, vel, precio, stream, desc in planes_data:
            p = ObjectService.create(
                TENANT,
                str(plan_type.id),
                {
                    "nombre": nombre,
        ...
        clientes_data = [
            ...
            (
                "Martin Alvarado",
                "1857306997",
                "martin.alvarado1@email.com",
                "0947338124",
                "Tena",
                "Av. De los Shyris 460-76",
                "Oriente",
                "activo",
                54.32,
                "2024-12-19",
        ...
        for i, (
            ...
            monto,
            fecha,
        ) in enumerate(clientes_data):
            c = ObjectService.create(
                TENANT,
                str(cliente_type.id),
                {
                    "nombre": nombre,
            ...
            LinkService.create(
                TENANT,
                str(lt_subscribes.id),
                str(c.id),
                str(planes[plan_name].id),
            )
        ...
        self.stdout.write(
            f"  Created {len(clientes)} clientes with plan and zona links"
        )
        ...
        for ced in ced_list:
            ...
            svc = ObjectService.create(
                TENANT,
                str(servicio_type.id),
                {
                    "tipo": "fibra",
                    "velocidad": "300 Mbps",
                    "estado": "activo",
                    "nodo_red": "OLT-Quito-Centro",
        ...
        self.stdout.write(
            f"  7 Object Types, 6 Link Types,"
            f" {len(clientes)} clientes, {len(planes)} planes,"
            f" {len(zonas)} zonas, {len(nodos)} nodos"
        )
