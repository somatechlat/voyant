...
def run_ingestion(
    ...
    self.update_state(
        state="RUNNING", meta={"progress": 0, "status": "Connecting to source"}
    )
    ...
    try:
        ...
        self.update_state(
            state="RUNNING", meta={"progress": 10, "status": "Fetching source config"}
        )
        ...
        self.update_state(
            state="RUNNING",
            meta={"progress": 20, "status": "Determining ingestion method"},
        )

        # Step 3: Execute ingestion
        self.update_state(
            state="RUNNING", meta={"progress": 30, "status": "Ingesting data"}
        )
        ...
        self.update_state(
            state="RUNNING", meta={"progress": 90, "status": "Registering lineage"}
        )
