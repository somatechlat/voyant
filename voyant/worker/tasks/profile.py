...
def run_profile(
    ...
    try:
        ...
        self.update_state(
            state="RUNNING", meta={"progress": 10, "status": "Querying via Trino"}
        )
        ...
        self.update_state(
            state="RUNNING", meta={"progress": 20, "status": "Fetching sample"}
        )

        # Step 2: Convert to DataFrame
        self.update_state(
            state="RUNNING", meta={"progress": 30, "status": "Converting to DataFrame"}
        )

        # Step 3: Run profiling
        self.update_state(
            state="RUNNING", meta={"progress": 40, "status": "Running ydata-profiling"}
        )
        ...
        self.update_state(
            state="RUNNING", meta={"progress": 70, "status": "Generating report"}
        )

        # Step 4: Save to MinIO
        self.update_state(
            state="RUNNING", meta={"progress": 80, "status": "Saving artifacts"}
        )
        ...
        self.update_state(
            state="RUNNING", meta={"progress": 90, "status": "Registering metadata"}
        )
