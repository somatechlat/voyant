...
class VoyantSpider(scrapy.Spider):
    ...
    def __init__(
        self, urls: List[str], callback: Optional[Callable[[Dict[str, Any]], None]] = None, *args, **kwargs
    ):
        """
...
class ScrapyClient:
    ...
    def crawl(
        ...
        settings = {
            ...
            "DEPTH_LIMIT": max_depth if follow_links else 0,  # 0 means no following links from start_urls
