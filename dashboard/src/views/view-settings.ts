    ...
    render() {
        ...
        <main class="ml-60 min-h-screen bg-surface p-8" role="main" aria-label="System settings">
            ...
            <div class="space-y-3" aria-live="polite">
                ...
                <div class="bg-white rounded-xl border border-gray-100 p-5 hover:border-brand transition-all">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500 mb-2">${s.description || 'No description'}</p>
                            ...
                            <span class="text-sm font-mono ${s.is_secret ? 'text-gray-500' : 'text-gray-700'}">${s.value}</span>`}
                        </div>
                ...
                ${this.settings.length === 0 ? html`<div class="text-center text-gray-500 py-12">No system settings</div>` : ''}
            </div>`}
        </main>`;
    }
}
