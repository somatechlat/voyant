...
export class ViewSearch extends LitElement {
    ...
    render() {
        ...
        <main class="ml-60 min-h-screen bg-surface p-8" role="main" aria-label="Search index management">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl border border-gray-100 p-5">
                    ...
                    <div class="flex items-center justify-between mt-2">
                        <span class="text-xs text-gray-500">${this.indexStatus}</span>
            ...
            ${this.loading ? html`<div class="text-center text-gray-500 py-8" role="status" aria-live="polite">Searching...</div>` : html`
            <div class="space-y-3" aria-live="polite">
                ...
                <div class="bg-white rounded-xl border border-gray-100 p-5 flex items-start justify-between hover:border-brand transition-all">
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-2">
                            <span class="text-xs font-mono text-gray-500">${r.id}</span>
                ...
                ${this.results.length === 0 && this.query ? html`<div class="text-center text-gray-500 py-8">No results</div>` : ''}
            </div>`}
        </main>`;
    }
}
