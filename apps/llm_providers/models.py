...
class LLMProvider(models.Model):
    ...
    api_base_url = models.CharField(
        max_length=500, help_text="OpenAI-compatible API base URL"
    )
    api_key = models.CharField(
        max_length=500, blank=True, help_text="API key (encrypted in Vault)"
    )
    api_key_vault_path = models.CharField(
        max_length=255,
        blank=True,
        help_text="Vault path for API key",
    )
...
class LLMModel(models.Model):
    ...
    name = models.CharField(
        max_length=200, help_text="Model ID (e.g. 'openai/gpt-oss-120b')"
    )
    ...
    supports_reasoning = models.BooleanField(
        default=False,
        help_text="Supports reasoning/chain-of-thought",
    )
