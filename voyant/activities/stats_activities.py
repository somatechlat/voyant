...
class StatsActivities:
    ...
    def describe_distribution(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise activity.ApplicationError(
                "R-Engine circuit breaker is open. Service unavailable.", non_retryable=True
            )
    ...
    def calculate_market_share(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if brand_df.empty or comp_df.empty:
                raise ValueError("Brand or competitor data cannot be empty for market share calculation.")
            ...
            raise activity.ApplicationError(
                f"Invalid input data for market share calculation: {e}", non_retryable=True
            ) from e
        except Exception as e:
    ...
    def perform_hypothesis_test(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise activity.ApplicationError(
                f"Hypothesis test failed due to unexpected error: {e}", non_retryable=False
            ) from e
