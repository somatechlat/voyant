...
try:
    ...
    from sklearn.metrics import (
        silhouette_score,
    )  # r2_score and accuracy_score calculated manually
    ...
    def detect_anomalies(
        ...
        try:
            ...
            logger.error(
                ...
                extra={"metric": "ml_inference_error", "type": "anomaly_detection"},
            )
    ...
    def train_classifier(
        ...
        try:
            ...
            logger.error(
                ...
                extra={"metric": "ml_training_error", "type": "classification"},
            )
    ...
    def train_regression(
        ...
        try:
            ...
            logger.error(
                ...
                extra={"metric": "ml_training_error", "type": "regression"},
            )
